-- Migration 011: Tambah kolom kode pada rkap_target dan rkap_kode pada cash_in
-- Membuat tabel rkap_target jika belum ada (dengan kolom kode langsung)
...
-- Tambah kolom kode jika tabel sudah ada tapi belum punya kolom kode
ALTER TABLE rkap_target
  ADD COLUMN IF NOT EXISTS kode VARCHAR(50);

-- Tambah kolom rkap_kode ke cash_in jika tabelnya sudah ada
ALTER TABLE cash_in
