...
const breadcrumbMap: Record<string, string[]> = {
  ...
  '/jalur-b/piutang': ['Jalur B', 'Piutang'],
  ...
  '/jalur-b/laporan-ho': ['Jalur B', 'Laporan Format HO'],
    ...
    <header className="fixed top-0 left-56 right-0 h-[56px] bg-white border-b border-gray-200 flex items-center justify-between px-5 z-30">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2 pl-1">
          <div className="h-7 w-7 rounded-full bg-[#1B4F72] flex items-center justify-center shrink-0">
