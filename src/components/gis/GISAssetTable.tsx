...
export function GISAssetTable({ onShowMap, onOpenKonsesi }: { onShowMap: (asset: GISAssetSummary) => void; onOpenKonsesi?: (konsesiKey: string) => void }) {
