...
class Kompensasi(Base):
    ...
    sppn_no = Column(String(100), nullable=True)
    sppn_dibuat_at = Column(DateTime(timezone=True), nullable=True)
    sppb_pph_no = Column(String(100), nullable=True)
    sppb_pph_dibuat_at = Column(DateTime(timezone=True), nullable=True)
